// Pour vraie enchères, mettre à false
let demoAuction = true;
// Pour les vraies enchères, remplir ces champs
let primaryImages = [];
let titles = [];
let subtitles = [];
let details = [];
...
function generateRandomAuctions() {
  ...
  // Description d'oeuvres random (lorem ipsum)
  $.getJSON(
